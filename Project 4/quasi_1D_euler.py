...
class quasi1DEuler:
    ...
    """
    def __init__(self, n, epsilon, convergence_tolerance=1e-12, max_iterations=1e5):
        ...
        self.CFL = 0.9                                # CFL number for determining time steps
    ...
    def solve(self, exit_pressure_ratio, mach_in=None):  # Solve the flow for a given exit pressure ratio
    ...
    def update_BC(self, mach_in):  # Updates the boundary conditions
        ...
        if mach_in is None:  # Case for the subsonic inlet condition
    ...
    def init_grid(self):  # Initializes the grid and sets initial conditions
        ...
        rho_i = self.Pt / (self.R_gas * self.Tt)
        self.W[:, :] = (rho_i,
                          0,
                          self.Pt / (self.g - 1))
